...
- **HCCL window offset errata**: A5 MTE2 DMA reads from HCCL window base bytes [16..31] return zeros.
  The host driver applies `winOffset=256` to skip the defective region.
