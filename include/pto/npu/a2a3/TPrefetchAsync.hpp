...
#ifndef PTO_NPU_A2A3_TPREFETCH_ASYNC_HPP
#define PTO_NPU_A2A3_TPREFETCH_ASYNC_HPP

// TPREFETCH_ASYNC for A2/A3. The implementation is arch-neutral (all backend
