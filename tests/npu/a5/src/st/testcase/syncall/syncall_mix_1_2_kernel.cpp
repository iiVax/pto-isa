...
extern "C" __global__ AICORE void RunSoftSyncAllMix12_1201_mix_aic(__gm__ int32_t __out__ *out,
...
extern "C" __global__ AICORE void RunSoftSyncAllMix12_1201_mix_aiv(__gm__ int32_t __out__ *out,
                                                                   __gm__ int32_t __out__ *flags,
                                                                   __gm__ int32_t __out__ *syncWorkspace)
{
    RunMixSyncAllBody<kMix12SoftParticipants>(out, flags, syncWorkspace);
...
{
    LaunchSoftMixKernel(reinterpret_cast<const void *>(&LaunchSoftSyncAllMix12), kMix12SoftTilingKey, out, flags,
