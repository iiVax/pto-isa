...
{
    textract_test<11, uint16_t, uint16_t, uint16_t>(63, 48, 66, 0, 0, 0, 128, 64, 256);
}
TEST_F(TEXTRACTTest, case12)
{
    textract_test<12, uint16_t, uint16_t, uint16_t>(68, 93, 97, 0, 0, 0, 128, 128, 128);
}
TEST_F(TEXTRACTTest, case14)
{
    textract_test<14, uint16_t, uint16_t, uint16_t>(59, 232, 61, 16, 16, 16, 64, 256, 64);
}
TEST_F(TEXTRACTTest, case21)
{
    textract_test<21, int32_t, int8_t, int8_t>(97, 231, 83, 0, 0, 0, 128, 256, 128);
}
TEST_F(TEXTRACTTest, case22)
{
    textract_test<22, int32_t, int8_t, int8_t>(71, 188, 82, 0, 0, 0, 128, 256, 128);
}
TEST_F(TEXTRACTTest, case23)
{
    textract_test<23, int32_t, int8_t, int8_t>(63, 112, 98, 32, 32, 32, 64, 128, 128);
}
TEST_F(TEXTRACTTest, case24)
{
    textract_test<24, int32_t, int8_t, int8_t>(106, 125, 60, 32, 32, 32, 128, 128, 64);
}