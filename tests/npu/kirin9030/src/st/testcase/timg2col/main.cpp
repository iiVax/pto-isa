...
{
    timg2col_test<2, uint16_t, uint16_t>(1, 4, 3, 8, 16, 4, 3, 3, 16, 16, 2, 1);
}
TEST_F(TIMG2COLTest, case3_float16)
{
    timg2col_test<3, uint16_t, uint16_t>(1, 4, 8, 16, 8, 4, 3, 3, 16, 8, 1, 1, 2, 2);
}
TEST_F(TIMG2COLTest, case4_int8)
{
    timg2col_test<4, int32_t, int8_t>(1, 1, 4, 8, 32, 1, 3, 3, 16, 32);
}
TEST_F(TIMG2COLTest, case6_float16_splitk)
{
    timg2col_test<6, uint16_t, uint16_t>(1, 4, 17, 5, 16, 4, 3, 3, 16, 16, 1, 2, 2, 1);
}
TEST_F(TIMG2COLTest, case7_float16_splitk)
{
    timg2col_test<7, uint16_t, uint16_t>(1, 2, 10, 12, 8, 2, 4, 4, 16, 8, 1, 1, 2, 2, 1, 2, 3, 0);
}
TEST_F(TIMG2COLTest, case8_int8_splitk)
{
    timg2col_test<8, int32_t, int8_t>(1, 2, 9, 20, 32, 2, 2, 2, 16, 32, 2, 2, 2, 2, 1, 1, 1, 0);
}
TEST_F(TIMG2COLTest, case10_float16_fractalZ4d)
{
    timg2col_test_fractal4d<10, uint16_t, uint16_t>(1, 4, 17, 5, 16, 36, 4, 16, 16, 3, 3, 1, 2, 2, 1);
}
TEST_F(TIMG2COLTest, case11_float16_fractalZ4d)
{
    timg2col_test_fractal4d<11, uint16_t, uint16_t>(1, 2, 10, 12, 8, 32, 2, 16, 8, 4, 4, 1, 1, 2, 2, 1, 2, 3, 0);
}
TEST_F(TIMG2COLTest, case12_int8_fractalZ4d)
{
    timg2col_test_fractal4d<12, int32_t, int8_t>(1, 2, 9, 20, 32, 8, 4, 16, 32, 2, 2, 2, 2, 2, 2, 1, 1, 1, 0);
}